        ...
        function actualizarHoraActualizacion() {
            document.getElementById('last-update').innerHTML = `<i class="fa-regular fa-clock mr-1 text-[#2563eb]"></i> ${new Date().toLocaleTimeString('es-MX', { hour: '2-digit', minute: '2-digit', second:'2-digit' })}`;
        }
            ...
            equiposFiltrados.forEach(eq => {
                ...
                card.innerHTML = `
                    ...
                    <div class="flex flex-wrap gap-2 items-center justify-between mt-3">
                        ...
                        <span class="text-xs text-[#2563eb] flex items-center gap-1"><i class="fa-regular fa-eye"></i> Ver detalles</span>
                    </div>
                `;
        ...
        function mostrarSeccion(tabId) {
            document.querySelectorAll('[data-tab]').forEach(btn => {
                ...
                btn.classList.toggle('text-[#2563eb]', active);
                ...
                <head>
                    ...
                    <style>
                        *{margin:0;padding:0;box-sizing:border-box}
                        ...
                        .header{background:linear-gradient(135deg,#0F4C81 0%,#2563eb 100%);color:#fff;padding:30px 35px;display:flex;justify-content:space-between;align-items:center}
                        .header h1{font-size:30px;font-weight:800;letter-spacing:1px}.header h1 span{color:#f97316}
                        ...
                        .card h3{font-size:16px;color:#2563eb;margin-bottom:12px;border-bottom:2px solid #f97316;padding-bottom:6px}
                        ...
                        .notas{background:#fff7ed;border-left:6px solid #f97316;padding:16px;border-radius:12px;margin-top:18px}
        ...
        function renderizarGaleriaSeguimiento() {
            ...
            seguimientoFotosBase64.forEach((src, idx) => {
                ...
                item.className = 'relative rounded-lg overflow-hidden border border-[#2563eb] bg-[#1E1E1E]';
                item.innerHTML = `
        ...
        function mostrarToast(mensaje, tipo = 'success') {
            ...
            toast.style.borderLeftColor = tipo === 'error' ? '#ef4444' : '#f97316';
            setTimeout(() => {
