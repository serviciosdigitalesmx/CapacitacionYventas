        ...
        async function guardarOrden() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    const mensaje = `Hola, tu equipo ha sido registrado en EL PROFE con el folio ${result.folio}. Puedes consultar el estado en: ${portalUrl.toString()}`;
        ...
        function generarPDFOrden(tipo = 'previa') {
            ...
            const accionPDF = tipo === 'previa'
                ? `<div style="text-align:center;padding:14px;background:#fff">
                        <button onclick="window.print()" style="background:#db321f;color:#fff;border:0;border-radius:8px;padding:10px 16px;font-weight:600;cursor:pointer">Imprimir / Guardar PDF</button>
                   </div>`
            ...
            const html = `
                ...
                <head>
                    ...
                    <style>
                        *{margin:0;padding:0;box-sizing:border-box} body{font-family:'Inter',sans-serif;background:#f4f7fc;padding:30px;color:#1e293b}
                        ...
                        .header h1{font-size:32px;font-weight:800;letter-spacing:1px}.header h1 span{color:#ff6929}
                        ...
                        .checks h3{color:#ff6929;margin-bottom:10px}.check-list{display:flex;gap:10px;flex-wrap:wrap}
                ...
                <body>
                    <div class="container">
                        <div class="header">
                            <div><h1>EL PROFE</h1><p>Orden de Servicio</p></div>
