        ...
        function actualizarHoraActualizacion() {
            document.getElementById('last-update').innerHTML = `<i class="fa-regular fa-clock mr-1 text-[#db321f]"></i> ${new Date().toLocaleTimeString('es-MX', { hour: '2-digit', minute: '2-digit', second:'2-digit' })}`;
        }
            ...
            equiposFiltrados.forEach(eq => {
                ...
                card.innerHTML = `
                    ...
                    <div class="flex flex-wrap gap-2 items-center justify-between mt-3">
                        ...
                        <span class="text-xs text-[#db321f] flex items-center gap-1"><i class="fa-regular fa-eye"></i> Ver detalles</span>
                    </div>
                `;
        ...
        function mostrarSeccion(tabId) {
            document.querySelectorAll('[data-tab]').forEach(btn => {
                ...
                btn.classList.toggle('text-[#db321f]', active);
                btn.classList.toggle('border-b-2', active);
                btn.classList.toggle('border-[#db321f]', active);
        ...
        function construirWaUrl(telefono, folio) {
            ...
            const mensaje = `Hola, te escribimos de el profe sobre tu equipo con folio ${folio}.`;
        ...
        function enviarWhatsAppCliente() {
            ...
            const limpio = String(telefono).replace(/\D/g, '');
            const destino = limpio.length === 10 ? `52${limpio}` : limpio;
            const mensaje = `Hola, te escribimos de el profe para informarte que tu equipo con folio ${folio} se encuentra en estado: ${estado}.`;
        ...
        function descargarFichaPDF() {
            ...
            const html = `
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Ficha ${e.FOLIO || 'EL PROFE'}</title>
                    ...
                    <style>
                        *{margin:0;padding:0;box-sizing:border-box}
                        ...
                        .header{background:linear-gradient(135deg,#0F4C81 0%,#db321f 100%);color:#fff;padding:30px 35px;display:flex;justify-content:space-between;align-items:center}
                        .header h1{font-size:30px;font-weight:800;letter-spacing:1px}.header h1 span{color:#ff6929}
                        ...
                        .card h3{font-size:16px;color:#db321f;margin-bottom:12px;border-bottom:2px solid #ff6929;padding-bottom:6px}
                        ...
                        .notas{background:#fff7ed;border-left:6px solid #ff6929;padding:16px;border-radius:12px;margin-top:18px}
                ...
                <body>
                    <div class="container">
                        <div class="header">
                            <div><h1>EL PROFE</h1><p>Ficha Técnica (Semáforo)</p></div>
        ...
        function renderizarGaleriaSeguimiento() {
            ...
            seguimientoFotosBase64.forEach((src, idx) => {
                ...
                item.className = 'relative rounded-lg overflow-hidden border border-[#db321f] bg-[#1E1E1E]';
                item.innerHTML = `
        ...
        function mostrarToast(mensaje, tipo = 'success') {
            ...
            toast.style.borderLeftColor = tipo === 'error' ? '#ef4444' : '#ff6929';
            setTimeout(() => {
