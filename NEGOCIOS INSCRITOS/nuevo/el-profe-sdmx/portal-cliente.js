        const CONFIG = {
            ...
            TIENDA_WHATSAPP: '528131590917',
            TIENDA_MAPS: 'https://maps.app.goo.gl/upJ56yzK5zb8ZWep8',
            LOGO_URL: './logo.webp',
        ...
        function renderizarFotosSeguimiento(raw) {
            ...
            fotos.forEach((src, idx) => {
                ...
                btn.type = 'button';
                btn.className = 'block rounded-lg overflow-hidden border border-[#db321f] hover:opacity-90 transition';
                btn.dataset.src = src;
        ...
        function mostrarToast(mensaje, tipo = 'success') {
            ...
            else toast.style.borderLeftColor = '#ff6929';
            setTimeout(() => {
