        ...
        document.getElementById('cotizadorForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                let mensaje = "*Nueva cotización - el profe*\n\n";
        ...
        document.querySelector('.copyright').innerHTML = 
            `© ${new Date().getFullYear()} el profe. Todos los derechos reservados.<br>
             Especialistas en reparación de electrónicos en Ciudad Base`;
