        const CONFIG = {
            ...
            TIENDA_WHATSAPP: '528100000000',
            TIENDA_MAPS: 'https://maps.app.goo.gl/BASE',
            LOGO_URL: './logo.webp',
        ...
        function renderizarFotosSeguimiento(raw) {
            ...
            fotos.forEach((src, idx) => {
                ...
                btn.type = 'button';
                btn.className = 'block rounded-lg overflow-hidden border border-[#2563eb] hover:opacity-90 transition';
                btn.dataset.src = src;
        ...
        function mostrarToast(mensaje, tipo = 'success') {
            ...
            else toast.style.borderLeftColor = '#f97316';
            setTimeout(() => {
