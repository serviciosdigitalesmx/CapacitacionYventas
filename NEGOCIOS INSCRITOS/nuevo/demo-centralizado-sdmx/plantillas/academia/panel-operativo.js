        ...
        async function guardarOrden() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    const mensaje = `Hola, tu equipo ha sido registrado en PLANTILLA ACADEMIA con el folio ${result.folio}. Puedes consultar el estado en: ${portalUrl.toString()}`;
        ...
        function generarPDFOrden(tipo = 'previa') {
            ...
            const html = `
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Plantilla Academia - Orden</title>
