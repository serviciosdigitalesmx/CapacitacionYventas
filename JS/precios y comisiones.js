        ...
        function setMarket(type) {
            ...
            if (type === 'elite') {
                ...
                updatePlan('p1', 'Cimentación Digital', 'Estructura fundamental para blindaje operativo inicial.', '$25,000', '$2,800', '$5,000');
                updatePlan('p2', 'Estructura de Control', 'Arquitectura de procesos para visibilidad y optimización de flujos.', '$35,000', '$3,500', '$8,500');
                updatePlan('p3', 'Blindaje & Transparencia', 'Cultura de evidencia multimedia y blindaje multimedia irrefutable.', '$45,000', '$4,800', '$12,000');
                updatePlan('p4', 'Arquitectura Corporativa', 'Digitalización de modelos de expansión y multisucursal a medida.', 'COTIZACIÓN', 'Custom', '25%');
                ...
                updatePlan('p1', 'Digitalización Operativa', 'Mapeo y migración de procesos manuales a una base digital sólida.', '$800', '$150', '$250');
                updatePlan('p2', 'Control de Gestión', 'Optimización de flujos y visibilidad de rendimiento en tiempo real.', '$1,500', '$350', '$450');
                updatePlan('p3', 'Blindaje de Marca', 'Cultura de transparencia y evidencia multimedia para protección total.', '$2,800', '$650', '$800');
                updatePlan('p4', 'Crecimiento Escalar', 'Integración multisucursal y arquitectura a la medida para expansión.', 'COTIZACIÓN', 'Custom', '25%');
                
                p3Shimmer.classList.add('hidden');
            }
        }

        function updatePlan(id, name, desc, price, rent, comm) {
            ...
            document.getElementById(id + '-rent').innerText = rent;
