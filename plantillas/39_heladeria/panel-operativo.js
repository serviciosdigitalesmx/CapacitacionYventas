        ...
        function generarPDFOrden(tipo = 'previa') {
            ...
            const accionPDF = tipo === 'previa'
                ? `<div style="text-align:center;padding:14px;background:#fff">
                        <button onclick="window.print()" style="background:{{COLOR_PRIMARY}};color:#fff;border:0;border-radius:8px;padding:10px 16px;font-weight:600;cursor:pointer">Imprimir / Guardar PDF</button>
                   </div>`
                ...
                <head>
                    ...
                    <style>
                        *{margin:0;padding:0;box-sizing:border-box} body{font-family:'Inter',sans-serif;background:#f4f7fc;padding:30px;color:#1e293b}
                        ...
                        .header h1{font-size:32px;font-weight:800;letter-spacing:1px}.header h1 span{color:{{COLOR_ACCENT}}}
                        ...
                        .checks h3{color:{{COLOR_ACCENT}};margin-bottom:10px}.check-list{display:flex;gap:10px;flex-wrap:wrap}
