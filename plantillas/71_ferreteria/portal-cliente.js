        const CONFIG = {
            ...
            TIENDA_WHATSAPP: '{{WHATSAPP}}',
            TIENDA_MAPS: '{{MAPS_URL}}',
            LOGO_URL: './logo.webp',
        ...
        function renderizarFotosSeguimiento(raw) {
            ...
            fotos.forEach((src, idx) => {
                ...
                btn.type = 'button';
                btn.className = 'block rounded-lg overflow-hidden border border-[{{COLOR_PRIMARY}}] hover:opacity-90 transition';
                btn.dataset.src = src;
        ...
        function mostrarToast(mensaje, tipo = 'success') {
            ...
            else toast.style.borderLeftColor = '{{COLOR_ACCENT}}';
            setTimeout(() => {
