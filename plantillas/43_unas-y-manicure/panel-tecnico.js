        ...
        function construirWaUrl(telefono, folio) {
            ...
            const mensaje = `Hola, te escribimos de Plantilla Barberia sobre tu equipo con folio ${folio}.`;
        ...
        function enviarWhatsAppCliente() {
            ...
            const limpio = String(telefono).replace(/\D/g, '');
            const destino = limpio.length === 10 ? `52${limpio}` : limpio;
            const mensaje = `Hola, te escribimos de Plantilla Barberia para informarte que tu equipo con folio ${folio} se encuentra en estado: ${estado}.`;
        ...
        function descargarFichaPDF() {
            ...
            const html = `
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Ficha ${e.FOLIO || 'PLANTILLA BARBERIA'}</title>
